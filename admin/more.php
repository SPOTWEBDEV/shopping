...
if (isset($_GET['item'])) {
    $item = $_GET['item'];
    $select = mysqli_query($connection, "SELECT product_table.*, client.email ,client.username FROM product_table,client WHERE client.id=product_table.user_id AND product_table.id = $item ");
                            ...
                            <form method="POST" class="w-full gap-y-6 ">
                                <div class="">
                                    ...
                                    while ($row = mysqli_fetch_assoc($select)) { ?>
                                        ...
                                        <div class="mb-8">
                                            <img style="width: 80%; height:500px;" src=".././uploads/products/<?php echo $row['product_front_photo'] ?>" alt="">
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input name="username" value="<?php echo $row['product_name'] ?>" type="text" id="firstNameInput2" class="form-input w-full border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter First Name" required readonly>
                                            </div>


                                            <div class="mb-4">
                                                <label for="email" class="inline-block mb-2 text-base font-medium">Product-price<span class="text-red-500">*</span></label>
                                                <input name="email" value="<?php echo $row['product_price']  ?>" type="text" id="cityInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Last Name" required readonly>
                                            </div>
                                            <div class="mb-4">
                                                <label for="email" class="inline-block mb-2 text-base font-medium">Quantity<span class="text-red-500">*</span></label>
                                                <input name="email" type="text" id="UsernameInput" value="<?php echo $row['product_quantity']  ?>" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Email" required readonly>
                                            </div>
                                            <div class="mb-4">
                                                <label for="phone" class="inline-block mb-2 text-base font-medium">Type<span class="text-red-500">*</span></label>
                                                <input name="phone_number" type="text" value="<?php echo $row['product_type']  ?>" id="UsernameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Phone Number" required readonly>
                                            </div>

                                            <div class="mb-4">
                                                <label for="phone" class="inline-block mb-2 text-base font-medium">about<span class="text-red-500">*</span></label>
                                                <input name="phone_number" type="text" value="<?php echo $row['about_product']  ?>" id="UsernameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Phone Number" required readonly>
                                            </div>

                                            <div class="mb-4">
                                                <label for="phone" class="inline-block mb-2 text-base font-medium">Status<span class="text-red-500">*</span></label>
                                                <input name="phone_number" type="text" value="<?php echo $row['status']  ?>" id="UsernameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Phone Number" required readonly>
                                            </div>
                                        </div>
