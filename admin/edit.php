...
if (isset($_GET['edit_id'])) {
         ...
         $select = mysqli_query($connection, "SELECT * FROM `client` WHERE `id`='$edit_id'");
...
<head>
         ...
         <meta charset="utf-8">
         <title><?php echo $sitename ?> | Edit User Page </title>
                                             ...
                                             <div class="card">
                                                      <div class="card-body">
                                                               ...
                                                               if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                                        ...
                                                                        $query = "UPDATE client SET username='$username', email='$email', phone_number='$phonenumber' WHERE id = $edit_id";
                                                                        $result = mysqli_query($connection, $query);
                                                                        echo mysqli_error($connection);

                                                                        if ($result) {
                                                                                 echo "<script>
                                                                                 window.open('./edit.php?edit_id=$edit_id','_self')
                                                                                          </script>
                                                                                          ";
                                                                        } else {
                                                                                 echo "<script>
