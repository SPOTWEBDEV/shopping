        ...
        <div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
            ...
            <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
                <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4 text-15">Edit User Information</h6>
                            <?php
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (!empty($newpassword) && !empty($confirmpassword)) {
                                    ...
                                    if ($newpassword ==  $confirmpassword) {
                                        ...
                                        $query = "UPDATE admin  SET `password`='$confirmpassword' WHERE id = $id";
                                        $result = mysqli_query($connection, $query);
                                        echo mysqli_error($connection);

                                        if ($result) {
                                            echo "<script>
                                                                                         alert('your password changing went successfully');
                                         ...
                                         echo "<script>alert('Your newpassword must match the confirmpassword')</script>" ;
                                    }
                                } else {
                            ...
                            <form method="POST">
                                <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                                    <div class="mb-4">
                                        <label for="username" class="inline-block mb-2 text-base font-medium">new-password<span class="text-red-500">*</span></label>
                                        <input name="newpassword" type="text" id="firstNameInput2" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter your-old-password" required>
                                    </div>

                                    <div class="mb-4">
                                        <label for="email" class="inline-block mb-2 text-base font-medium">confirm-password<span class="text-red-500">*</span></label>
                                        <input name="confirmpassword" type="text" id="cityInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter your-new-password" required>
                                    </div>
                                    <!-- <div class="mb-4">
                                    ...
                                    <!-- <div class="mb-4">
                                                                                          <label for="phone" class="inline-block mb-2 text-base font-medium">Phone Number <span class="text-red-500">*</span></label>
