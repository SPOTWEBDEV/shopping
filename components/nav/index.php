    ...
    <nav class="bg-white py-1.5">
        <div class="container flex items-center justify-between">
            ...
            <div class="flex items-center">
                <!-- Wish List -->
                <div class="py-2">
                    <a href="wishlist.html" class="relative flex-col items-center">
                ...
                <div class="relative group py-2">
                    ...
                    <div class="absolute top-full right-[1px] bg-white z-20 rounded-b-[3px] py-5 px-[15px] w-[205px] shadow-sm mt-3.5 group-hover:mt-[5px] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                        ...
                        <div class="pt-2.5">
                            <a href="my-account.html" class="flex items-center relative w-full mt-[7px] text-[15px] pl-8 text-[#464545] hover:text-primary transition duration-200">
                            ...
                            <a href="wishlist.html" class="flex items-center relative w-full mt-[7px] text-[15px] pl-8 text-[#464545] hover:text-primary transition duration-200">
