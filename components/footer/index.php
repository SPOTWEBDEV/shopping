...
<?php
                        if(isset($_POST['enter'])){
                            ...
                            $statement="INSERT INTO `subscribe`(`id`,`email`) VALUES('','$sub_email') ";
                        ...
                        <div class="w-full md:pl-3 lg:pl-0">
                            <div>
                                ...
                                <form class="flex" method="POST">
                                    <input type="email" name="sub_email" placeholder="Your email address" class="py-2.5 px-[15px] text-[13px] w-full sm:w-[230px] md:w-full lg:w-[230px] text-secondary bg-transparent rounded-l-[5px] border border-[#c7c7c7] focus:ring-0 focus:border-primary" required>
                                    <button type="submit" name="enter" class="default_btn py-2 px-2.5 min-w-[105px] rounded-r-[5px] rounded-l-none">
                                        SUBSCRIBE
                                    </button>
                                </form>
                            </div>
                        ...
                        <div class="w-1/2 lg:px-3">
                            <div>
                                ...
                                <a href="" class="text-[15px] leading-6 text-secondary block mb-3">Manage
                                    Account</a>
                                <a href="return-order.html" class="text-[15px] leading-6 text-secondary block mb-3">Return Order</a>
                            </div>
                        </div>
                                ...
                                <div>
                                    <p class="text-[15px] text-secondary relative pl-8 mb-[13px]">
                                        <span class="absolute left-1 top-1"><svg width="15" height="15"
                                            ...
                                            </svg></span> 7895 Dr New Albuquerue, NM 19800, <br> United States Of America
                                    </p>
                                    <p class="text-[15px] text-secondary relative pl-8 mb-[13px]">
                                        <span class="absolute left-1 top-1"><svg width="15" height="15"
                                                viewBox="0 0 24 24">
                                    ...
                                    <p class="text-[15px] text-secondary relative pl-8 mb-[13px]">
                                        <span class="absolute left-1 top-1"><svg width="15" height="15"
                                            ...
                                            </svg></span> <?php echo $siteemail ?>
                                    </p>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mt-1.5 flex">
                                    <a href="#" class="bg-[#3B5998] w-8 h-8 flex items-center justify-center rounded-full mr-3 leading-8 text-white">
                                    ...
                                    <a href="#" class="bg-[#00ACEE] w-8 h-8 flex items-center justify-center rounded-full mr-3 leading-8 text-white">
                                        <svg width="15" height="15" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M22.46 6c-.77.35-1.6.58-2.46.69c.88-.53 1.56-1.37 1.88-2.38c-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29c0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15c0 1.49.75 2.81 1.91 3.56c-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07a4.28 4.28 0 0 0 4 2.98a8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56c.84-.6 1.56-1.36 2.14-2.23Z" />
                                        </svg>
                                    </a>
                                    <a href="#" class="bg-[#D53982] w-8 h-8 flex items-center justify-center rounded-full mr-3 leading-8 text-white">
        ...
        <div class="container">
            <div class="md:flex md:flex-wrap items-center">
                <div class="w-full md:w-1/2 text-center md:text-start mb-2.5 md:mb-0">
                    <p class="text-base text-[#F9F9F9]">© <?php echo $sitename ?> - All Rights Reserved</p>
                </div>
