        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-6">
                <div>
                    ...
                    <h3 class="text-2xl lg:text-3xl uppercase mb-3">Innovative and Trendy <br class="d-none d-xl-block"> Shopping Experiences</h3>
                    <p class="mb-4">
                        Since day one, we've been redefining how people shop online—bringing the latest trends, timeless style, and unbeatable convenience to customers worldwide. We’re passionate about fashion, driven by innovation, and committed to delivering exceptional value and service.
                    </p>
    ...
    <div class="container grid  grid-cols-12 gap-6 mt-3">
        ...
        <div class="col-span-12 lg:col-span-7">
            <div class="about_hiscont ps-xl-2">
                ...
                <h3 class="text-2xl lg:text-3xl uppercase mb-3">Our vision is simple - We exist to <br class="d-none d-xl-block"> enhance every shopping experience</h3>
                <p class="mb-4">
                    We are dedicated to redefining online shopping by blending style, innovation, and customer-centric service. Our goal is to create seamless, personalized, and delightful shopping journeys that inspire confidence and satisfaction.
                </p>
                <div>
                    <p class="flex items-center gap-2 mb-2">
                        ...
                        </span> We build trusted relationships with our customers
                    </p>
                    <p class="flex items-center gap-2 mb-2">
                        <span class="text-primary me-2">
                            <svg width="16" height="16" viewBox="0 0 1024 1024">
                        ...
                        </span> We empower creativity and reward fresh ideas
                    </p>
                    <p class="flex items-center gap-2 mb-2">
                        <span class="text-primary me-2">
                            <svg width="16" height="16" viewBox="0 0 1024 1024">
                        ...
                        </span> We adapt quickly to new shopping trends
                    </p>
                    <p class="flex items-center gap-2 mb-2">
                        <span class="text-primary me-2">
                            <svg width="16" height="16" viewBox="0 0 1024 1024">
                        ...
                        </span> We operate with transparency and trust
                    </p>
                </div>
            </div>
        </div>
